...
public class MathGeometry {
    ...
    public double triangleArea(double base, double height) {
        if (base < 0 || height < 0) {
            throw new IllegalArgumentException("Floor and height cannot be negative!");
        }
    ...
    public double hypotenuse(double a, double b) {
        if (a < 0 || b < 0) {
            throw new IllegalArgumentException("hypotenuse cannot be calculated with negative sides!");
        }
